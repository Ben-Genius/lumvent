    ...
    <section className='bg-[#fff5f5] py-16'>
      <div className="container mx-auto p-2">
        <div className=''>
          ...
          {/* left hero section */}
          <center>
            <div className='mix-blend-blend rounded-3xl border-[1px] border-sky-600 py-2 max-w-[22rem] mx-auto whitespace-nowrap bg-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%'>
              <h4 className='mix-blend-lighten text-sm text-center align-middle text-white'>
                Host your holiday party with Luma -- </h4>
              
            </div>
            <svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 724 264" width={50} height={50} className="text-gray-500">
              <g fill="currentColor">
