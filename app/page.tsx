        ...
        <div className='p-2'>
          <div className='flex flex-col sm:flex-row sm:gap-10 justify-center items-center'>
            ...
            <div className='mx-auto'>
              <div className='rounded-3xl border-[1px] border-sky-600 py-2 max-w-xs md:max-w-sm mx-auto sm:mx-0 mb-3 whitespace-nowrap bg-gradient-to-r from-indigo-500 via-sky-500 to-emerald-500 hover:text-white'>
              ...
              <svg
                ...
                viewBox='0 0 724 264'
                className='text-gray-500 w-16 xs:w-24 my-5 mx-auto sm:mx-0 hover:text-black transition duration-500'
              >
                {/* SVG path here */}
                <g fill='currentColor'>
              ...
              <h4 className=' font-bold text-center sm:text-left text-5xl md:text-6xl lg:text-7xl'>
                Delightful events
              </h4>

              <div className='flex flex-col sm:flex-row m-0 p-0 items-center justify-center sm:items-start'>
                <h4 className='text-2xl xs:text-3xl lg:text-4xl bg-clip-text text-transparent bg-gradient-to-r from-blue-700 via-pink-500 to-orange-500 font-semibold'>
                  start here.
                </h4>
              </div>

              <p className='max-w-xs text-md xs:text-xl my-3'>
            ...
            {/* Video background */}
            <video autoPlay loop muted className="w-96 h-96 sm:w-[35rem] sm:h-[35rem]">
